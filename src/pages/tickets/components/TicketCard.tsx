        ...
        >
            <div className="p-4">
                ...
                <h3 className="font-m text-sm text-gray-600 mb-2 line-clamp-2 leading-tight">
                    {ticket.ticketNumber} <span className={`${ticket.status === "CLOSE" ? "text-red-500 text-xs" : "text-green-500 text-xs"}`}>{`(${ticket.status})`}</span> - {ticket.partName || "No part specified"}
                </h3>
